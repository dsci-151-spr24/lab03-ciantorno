...
***This Buzzfeed headline is supported by data because this graph shows that most living laureates were based in the US when they won their prizes.***
...
ggplot(data = nobel_living_science, aes(y=country_us, fill=born_country_us)) +
  ...
  facet_wrap(~category)
```    
***The data appears to support Buzzfeed's claim because the red parts of the USA bars in this graph appear to have a similar count as the ones in the Buzzfeed article.*** 
...
***Germany is the most common with 20 followed closely by Japan and UK.***
