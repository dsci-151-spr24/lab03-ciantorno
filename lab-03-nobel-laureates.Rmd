...
glimpse(nobel)
```
Each row represents a Nobel laureate.
...
ggplot(nobel_living_science, aes(x = category, fill = "USA")) +
  geom_bar(position = "dodge") +  
  coord_flip() +  
  facet_wrap(~category) +  
  labs(title = "Nobel Prize Winners: US vs Other Countries by Category",
       x = "Number of Laureates",
       y = "Category",
       fill = "Location") +
  scale_fill_manual(values = c("US" = "blue", "Other" = "red")) +  
  theme_minimal()  
```
